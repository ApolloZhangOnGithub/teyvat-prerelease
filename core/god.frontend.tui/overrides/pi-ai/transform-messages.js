const NON_VISION_USER_IMAGE_PLACEHOLDER = "[image]";
const NON_VISION_TOOL_IMAGE_PLACEHOLDER = "[image]";
...
function downgradeUnsupportedImages(messages, model) {
    // 2026-09-05（ISSUE 126，debug 定位）：模型定义可能缺 input 字段（如 models.dev 合成/第三方目录的模型）——
    // model.input undefined → .includes 抛 TypeError（thinkingmachines/inkling:free 实测炸点）。防御：undefined 视为不支持图片。
