...
export class Theme {
    ...
    bold(text) {
        // 2026-09-15（用户）：WSL 下 SGR 1 不提亮——dark 主题显式加白与 macOS bold-brighten 观感一致；light 下白字不可见跳过
        if (_isWSLTheme && currentThemeName !== "light") return chalk.bold(chalk.rgb(255, 255, 255)(text));
