...
export async function viewHandler(_args: any, ctx: any) {
  ...
  const getItems = () => {
    ...
    return [
      ...
      { id: "toolExpanded", label: T("Tool 展开", "Tool Expand"), currentValue: toolExpanded ? T("展开", "Expanded") : T("折叠", "Collapsed"), values: [T("折叠", "Collapsed"), T("展开", "Expanded")] },
      ...
      { id: "compactExecute", label: T("Execute 结果", "Execute Result"), currentValue: compactExecute ? "Compact" : T("完整", "Full"), values: [T("完整", "Full"), "Compact"] },
      { id: "breakAnd", label: T("&& 换行", "&& Break"), currentValue: breakAnd ? T("拆分", "Split") : T("不拆", "Keep"), values: [T("不拆", "Keep"), T("拆分", "Split")] },
      ...
      { id: "footerTokens", label: T("Footer 履历", "Footer Tokens"), currentValue: footerTokenmaxxed ? T("显示", "Show") : T("隐藏", "Hide"), values: [T("隐藏", "Hide"), T("显示", "Show")] },
      ...
      { id: "pinDev", label: "Pin dev", currentValue: showPinDev ? T("显示", "Show") : T("隐藏", "Hide"), values: [T("隐藏", "Hide"), T("显示", "Show")] },
      { id: "colorfulRank", label: T("履历多彩", "Colorful Rank"), currentValue: tokenmaxxedColorful ? T("开", "On") : T("关", "Off"), values: [T("关", "Off"), T("开", "On")] },
    ];
  };
  ...
  const onChange = (id: string, value: string) => {
    switch (id) {
      ...
      case "footerTokens": {
        const show = value === T("显示", "Show");
        (globalThis as any).__genshinFooterTokenmaxxed = show;
        save("footerTokenmaxxed", show);
        break;
      }
      case "footerProvider": {
        const show = value === T("显示", "Show");
      ...
      case "pinDev": {
        const show = value === T("显示", "Show");
        (globalThis as any).__genshinShowPinDev = show;
        save("showPinDev", show);
        break;
      }
      case "colorfulRank": {
        const on = value === T("开", "On");
