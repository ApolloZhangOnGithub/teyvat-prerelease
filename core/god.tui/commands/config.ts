...
function syncModelsJson(services: Record<string, any>) {
  ...
  } catch (e) { console.error("[god.tui/commands/config.ts] syncModelsJson: " + ((e as any)?.message || e)); }
}
...
function syncProviderEnvKey(provider: string, services: Record<string, any>): void {
  ...
  } catch (e) { console.error("[god.tui/commands/config.ts] syncProviderEnvKey: " + ((e as any)?.message || e)); }
}
...
function registerToM(provider: string): void {
  ...
  } catch (e) { console.error("[god.tui/commands/config.ts] registerToM: " + ((e as any)?.message || e)); }
}
...
function unregisterFromM(provider: string): void {
  ...
  } catch (e) { console.error("[god.tui/commands/config.ts] unregisterFromM: " + ((e as any)?.message || e)); }
}
