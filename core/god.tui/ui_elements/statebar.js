// god.tui/ui_elements/statebar.js
// ── StatusBar: 状态栏唯一真相源 ──────────────────────────────────────────────
...
// 2026-09-15（用户定位，windows_first_agent_01 转达）：✳（U+2733）在 Windows/WSL 终端被字体回退渲染成 emoji，视觉不一致——
...
export class StatusBar {
  ...
  _followBottom() {
    const pos = globalThis.__genshinStatebarPosition ?? "footer"; // 2026-09-15（用户）默认 footer
