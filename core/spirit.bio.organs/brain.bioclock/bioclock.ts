...
export default function (pi: ExtensionAPI) {
  ...
  // 2026-09-12：备份调度代码已移至 god.frontend.cli/backup.ts（startAutoBackup）。
  // 原代码由 genshin-v0.3.2-dev-01 (af5c5269) 误放在此文件——备份调度不属于 bioclock 职责
  // （bioclock 只管时间戳标记和日期通知）。已迁移，此处只留注释说明历史。
}
